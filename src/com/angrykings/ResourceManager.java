...
<<<<<<< HEAD
		textureAtlas = new BitmapTextureAtlas(gameActivity.getTextureManager(), 280, 302, TextureOptions.NEAREST);
=======
		textureAtlas = new BitmapTextureAtlas(gameActivity.getTextureManager(), 280, 306, TextureOptions.BILINEAR);
